...
ODOM_FRAME = 'odom'
# laser body offset relative to base_link (models/stretch.xml)
LASER_OFFSET = (0.004, 0.0, 0.1664)
...
class StretchSimNode(Node):
    ...
    def _broadcast_static_tf(self):
        """Broadcast the static base_link -> laser transform."""
        t = TransformStamped()
        t.header.stamp = self.get_clock().now().to_msg()
        t.header.frame_id = BASE_FRAME
        t.child_frame_id = LASER_FRAME
        t.transform.translation.x = LASER_OFFSET[0]
        t.transform.translation.y = LASER_OFFSET[1]
        t.transform.translation.z = LASER_OFFSET[2]
